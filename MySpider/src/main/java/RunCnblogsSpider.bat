...
REM 如下启动不了（TODO：待调查）
REM java -jar MySpider_0.0.2-SNAPSHOT_JDK1.8.jar URL=http://www.cnblogs.com/taichu/ LocalBackupFolder=H:/博客备份/博客园-www.cnblogs.com/taichu/

REM 如下用绝对路径来启动爬虫
REM java -cp .;MySpider_0.0.2-SNAPSHOT_JDK1.8.jar MySpider.spider.CnblogsSpider URL=http://www.cnblogs.com/taichu/ LocalBackupFolder=J:/360YUNPAN/360SYNC/我的程序/私人博客/博客园备份/博客园-www.cnblogs.com/taichu/

@ECHO ON
REM 如下用相对路径来启动爬虫（有利于将程序和数据都放在云盘上，因为云盘对在本地绝对路径不同，但相对路径不变！）
java -cp .;MySpider_0.0.2-SNAPSHOT_JDK1.8.jar MySpider.spider.CnblogsSpider URL=http://www.cnblogs.com/taichu/ LocalBackupFolder=../../../../私人博客/博客园备份/博客园-www.cnblogs.com/taichu/
