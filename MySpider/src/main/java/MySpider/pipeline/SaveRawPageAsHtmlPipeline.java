 ...
 *
 */
public class SaveRawPageAsHtmlPipeline extends FilePipeline {
	private static Logger log = Logger.getLogger(SaveRawPageAsHtmlPipeline.class);

	/**
	 * create a FilePipeline with default path"/data/webmagic/"
	 */
	public SaveRawPageAsHtmlPipeline() {
		//设定默认绝对路径，如果初始化的时候没有设定（只支持win）
		setPath("c:/data/myspider/");
	}

	public SaveRawPageAsHtmlPipeline(String path) {
		setPath(path);
	}
